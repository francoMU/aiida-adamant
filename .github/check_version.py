...
Check version number in setup.json and aiida_adamant/__init__.py and make sure
they match.
"""
...
import aiida_adamant  # pylint: disable=wrong-import-position
version = aiida_adamant.__version__
